 ...
 * sure you understand how it works and why it is not very efficient. You cannot change
 * the implementation for Assignment 1 but we will see later in the course how to implement
 * the dictionary in a much more efficient way using search trees
